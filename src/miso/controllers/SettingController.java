...
public class SettingController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		misoButton.setStyle("-fx-graphic: url('/miso/icon/miso.png');"  + "-fx-background-color: #FFFFFF;" +"-fx-border-color: #FF9933;" + "-fx-border-width:4.0px");
		...
		nodeList1.setTranslateY(com.sun.glass.ui.Screen.getMainScreen().getHeight() -1030);
...
//		nodeList1.addAnimatedNode(ocrToggleButton);
