...
public class Scope {
	...
	private HotKeySettingView hotKeySettingView;
...
//	private boolean clicked = false;
	...
	public AnchorPane getKeyboardPane() {
		return keyboardPane;
	}

	public void setKeyboardPane(AnchorPane keyboardPane) {
		this.keyboardPane = keyboardPane;
	}

	public HotKeySettingView getHotKeySettingView() {
		return hotKeySettingView;
	}

	public void setHotKeySettingView(HotKeySettingView hotKeySettingView) {
		this.hotKeySettingView = hotKeySettingView;
	}
